...
export const GENERATE_CONTENT: 'contentItems/GENERATE_CONTENT' = 'contentItems/GENERATE_CONTENT';
...
export type GenerateContentAction = {|
  ...TaskSagaAction,
  type: typeof GENERATE_CONTENT,
  payload: {|
