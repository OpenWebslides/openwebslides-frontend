...
class PureOutgoingPullRequest extends React.Component<Props> {
  ...
  renderOutgoingPullRequest = (pullRequest: m.PullRequest): React.Node => {
    const { t } = this.props;

    return (
      <Item data-test-id="outgoing-pull-request">
        <Item.Content>
          <Item.Header as="strong" data-test-id="outgoing-pull-request-message">
            {/* TODO: link to PR */}
            {pullRequest.message}
          </Item.Header>
          <Item.Meta>
  ...
  render(): React.Node {
    ...
    return (
      <FetchWrapper
        render={this.renderOutgoingPullRequest}
...
const OutgoingPullRequest = withNamespaces()(PureOutgoingPullRequest);

export { PureOutgoingPullRequest };
export default OutgoingPullRequest;
